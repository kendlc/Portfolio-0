  ...
  return (
    <div className="wrap">
      <div id="projects" className="container" style={{ minHeight: "100vh" }}>
        ...
        <div
          className="row d-flex d-flex justify-content-center mt-4"
          data-aos="fade-right"
        ...
        >
          ...
          >
            ...
            <a
              href="https://pokemon-quizzr.netlify.app/"
            ...
            <div>
              ...
              >
                Pokemon Quizzr is a web quiz app that lets you browse and search
                all 898 pokemon on the Pokedex, play a quiz game from any
                pokemon generation of your choice, and tracks your score to be
                display on the Leaderboard. To add, it is accessible,
                interactive and responsive on any device!
              </p>
              <p>ReactJS | Firebase | Firestore | Pokemon API | Bootstrap</p>
              <p>
                <a
                  href="https://github.com/kendlc/Project3-Pokequizzr"
                  className="mx-2"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        >
          ...
          <div
            className="col-sm-6 hoverImage  mb-sm-4 d-block d-sm-none"
            onMouseEnter={() => {
              setTimeout(() => {
          ...
          >
            ...
            <div>
              ...
              >
                In this group project, the team utilize collaborated to make an
                Expense Trackr application that helps you to organize your
                finances keeping track of all your expenses and incomes. It was
                built to have web and mobile responsiveness on all devices.
              </p>
              <p>ReactJS | Ruby on Rails | PostgreSQL | Bootstrap | CSS</p>
              <p>
                <a
                  href="https://github.com/kendlc/Project2-Expense-Trackr-Client"
                  className="mx-2"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div
            className="col-sm-6 hoverImage  mb-sm-4 d-none d-sm-block"
            onMouseEnter={() => {
              setTimeout(() => {
                setShowGifP2("./images/projects/srp2.gif");
              }, 0);
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Manga-shoppu is an e-commerce web application project that
                allows users to purchase different kind of mangas. Users can add
                products to their carts, have a subtotal and total costs on
                their cart and checkout. While admin users can create and add
                products.
              </p>
              <p>Ruby on Rails | PostgreSQL | Jikan API | HTML | CSS</p>
              <p>
                <a
                  href="https://github.com/kendlc/Project1-Manga-Shoppu"
                  className="mx-2"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        >
          ...
          >
            ...
            <a
              href="https://kendlc.github.io/Project0-Tictactoe/"
              className="mx-2 text-decoration-none text-reset"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <div>
              ...
              >
                In making this project, I utilised Javascript, CSS, and jQuery
                to make a fun interactive TicTacToe game that lets you play 1v1
                and demonstrates a nice responsive UI.
              </p>
              <p>jQuery | Javascript | HTML | CSS</p>
              <p>
                <a
                  href="https://github.com/kendlc/Project0-Tictactoe"
                  className="mx-2"
                  target="_blank"
                  rel="noreferrer"
                >
