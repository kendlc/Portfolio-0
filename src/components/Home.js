    ...
    return (
        ...
        <div className="row d-flex h-100">
            <div className="col-sm-7 align-self-center mt-5 mt-sm-0 mb-sm-5 wrap">
                ...
                <h1 className="display-1 d-flex justify-content-center justify-content-sm-end ken"
                style={{color: 'whitesmoke', zIndex: '4'}}
                >KEN DELA CRUZ</h1>
                <h1 className="d-flex justify-content-center justify-content-sm-end titleHeading"
                style={{color: '#C7D0D8'}}
